...
tspan = 0:0.001:5;
x0 = [40;1;1;0];
[odet, odex] = ode45(@(odet,odex) sys(odet,odex,approxA,approxB,Ups,linspace(0,5,length(Ups)) ),tspan,x0);
...
function  dx = sys(t,x,A,B,u,tspan)
   uact = interp1(tspan,u,t);
   dx = A*x + B*uact;
end
